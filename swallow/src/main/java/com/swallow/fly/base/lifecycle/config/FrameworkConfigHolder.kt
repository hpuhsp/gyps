...
object FrameworkConfigHolder {
    ...
    private fun logConfigInfo() {
        Timber.d("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Timber.d("Framework Configuration Loaded")
        Timber.d("App Config: ${if (appConfig != null) "Loaded" else "None"}")
        Timber.d("Module Configs: ${moduleConfigs.size}")
        moduleConfigs.sortedByDescending { it.priority }.forEach { provider ->
            Timber.d("  - [Priority ${provider.priority}] ${provider.moduleName}")
        }
        Timber.d("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    }
}
