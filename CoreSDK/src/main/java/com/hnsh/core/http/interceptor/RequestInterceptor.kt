...
import com.hnsh.core.http.printer.CharacterHandler
import com.hnsh.core.http.printer.FormatPrinter
import com.hnsh.core.utils.UrlEncoderUtils
import com.hnsh.core.utils.ZipHelper
import okhttp3.*
import okio.Buffer
...
class RequestInterceptor @Inject constructor() : Interceptor {
    ...
    @JvmField
    @Inject
    var printLevel: Level = Level.ALL
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        originalResponse = try {
            ...
            val response = mHandler?.redirectRequest(chain, request, e)
            if (null != response) {
                return response
            } else {
        ...
        return if (mHandler != null) mHandler!!.onHttpResultResponse(
            bodyString,
            chain,
            originalResponse
